...
// A FileService represents filesystem resources and provides a level
// a indirection that trades off performance with the ability to avoid
// running out of OS file descriptors.
type FileService struct {
	reqs chan bool
}

// NewFileService creates FileService that services N concurrent
// FileLike requests.
