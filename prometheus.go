...
var prometheusStats = map[string]string{
	...
	"pct_cpu_gc":                     "metric",
	"num_bytes_used_ram":             "metric",
	"avg_grpc_queries_latency":       "metric",
	"num_files_on_disk":              "metric",
	"num_pindexes_actual":            "metric",
	"num_pindexes_target":            "metric",
	"num_mutations_to_index":         "metric",
	"num_recs_to_persist":            "metric",
	"num_bytes_used_disk":            "metric",
	"last_access_time":               "metric",
	"avg_queries_latency":            "metric",
	"avg_internal_queries_latency":   "metric",
	"num_bytes_used_disk_by_root":    "metric",
	"num_root_filesegments":          "metric",
	"num_root_memorysegments":        "metric",
	"curr_batches_blocked_by_herder": "metric",
}
